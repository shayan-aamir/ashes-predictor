...
This module is integrated with the Recommendation System:
- Venue-based recommendations use pitch conditions from this module
- Hybrid recommendations consider venue characteristics
- Content-based filtering can be enhanced with pitch analysis
"""
